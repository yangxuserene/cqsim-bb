        ...
        while (temp_readNum<self.rnum or self.rnum<=0):
            ...
            if tempStr[0] != nr_sign:   # The job trace line
                if (temp_start>=self.anchor):
                    ...
                    '''this is for mutated trace only, transform processor num to node num'''               
                    
#                     tempInfo['usedProc']= tempInfo['usedProc']* random.randint(2,4)
#                     tempInfo['reqProc'] = tempInfo['usedProc']
#                     print "kkkkkkkkk", tempInfo['usedProc'], tempInfo['reqProc']
