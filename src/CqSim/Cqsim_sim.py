...
#         print self.module['job'].job_info(job_index)['reqTime'],"######"
...
#         penalty = random.uniform(1.5, 2.5)
# #         penalty = 1.0
#         self.module['job'].job_info(job_index)['run'] *= penalty
#         self.module['job'].job_info(job_index)['reqTime'] *= penalty
#         print self.module['job'].job_info(job_index)['reqTime'],"xxxxxx"
