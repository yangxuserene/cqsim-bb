...
#                 proc_num = tempInfo['usedProc']
#                 if(proc_num%8!=0):
# #                     while(1):
# #                         print "happen!"
#                     proc_num = ((proc_num/8)+1)*8
#                     freg_proc = proc_num - tempInfo['usedProc']
#                     tempInfo['usedProc'] = proc_num
#                     tempInfo['reqProc'] = proc_num
#                                          
#                     Dis_Metric.inter_freg(freg_proc, proc_num)


                '''convert processor number to node number'''
#                 proc_num = tempInfo['usedProc']
#                 if(proc_num%8 == 0):
#                     proc_num = proc_num/8
#                     tempInfo['usedProc'] = proc_num
